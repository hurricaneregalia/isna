...
export default function LogoEffectInverse({ imageUrl }) {
    ...
    img.onload = () => {
      ...
      for (let y = 0; y < canvas.height; y++) {
        for (let x = 0; x < canvas.width; x++) {
          ...
          // If the pixel's brightness is lower than the threshold, it should be white, otherwise black
          let newColor = brightness < localThreshold ? 255 : 0; // Set to white if below threshold, black if above

          // Set the pixel color (white or black)
