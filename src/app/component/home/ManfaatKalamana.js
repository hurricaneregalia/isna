...
export default function ManfaatKalamana({ secId, data }) {
  return (
    <Wrapper secId={secId}>
      <div className="flex sm:flex-row flex-col items-center sm:items-start gap-10 sm:gap-16">
        {/* LEFT SECTION */}
        <div className="sm:w-6/12 w-full space-y-6 sm:space-y-8">
          ...
          <ListItem data={data.item} listFor="good" gridCol=" grid-cols-2" />
        </div>
