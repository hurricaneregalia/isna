...
export default function BtnLinkPrimary({ btnTxt, btnUrl, iconLeft, iconRight, animate, btnFull }) {
  ...
  return (
    <Link href={btnUrl} className={`btn btn-primary rounded-full ${btnFullFx}`}>
      {iconLeftFx}
      {btnTxt}
      {iconRightFx}
    </Link>
