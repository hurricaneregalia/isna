      ...
      <div className="relative w-full overflow-hidden rounded-4xl rounded-tr-none min-h-screen items-center flex bg-neutral">
        <div className="lg:w-10/12 sm:w-11/12 w-full mx-auto">
          <div className="absolute inset-0">
            ...
            <div className="absolute inset-0 lg:bg-linear-to-r bg-linear-to-b from-primary to-secondary opacity-90"></div>
            <div className="absolute inset-0 bg-primary/50"></div>
          </div>
          <div className="relative w-full flex items-center px-6 md:px-16 lg:px-24 py-32 lg:flex-row flex-col-reverse gap-15">
