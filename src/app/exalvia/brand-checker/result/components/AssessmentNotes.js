  ...
  return (
    <div className={`collapse join-item ${isOpen ? "collapse-open" : ""}`}>
      ...
      <div className="collapse-content text-sm">
        <div className="sm:p-8 p-4  bg-base-100  rounded-2xl rounded-tr-none">
          {result.normalizedScore === 100 ? (
            <div className="flex items-start p-4 rounded-bl-2xl bg-red-500">
            ...
            <div>
              <div className="space-y-2">
                {allFlags.map((flag, index) => (
                  <div key={index} className="flex items-start gap-2 p-3 bg-yellow-50 border border-warning/50 rounded-2xl rounded-tr-none">
