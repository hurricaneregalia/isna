...
export default function AssessmentDetails({ result, isOpen, onToggle, title }) {
  return (
    <div className={`collapse join-item border-b border-base-300 ${isOpen ? "collapse-open" : ""}`}>
      ...
      <div className="collapse-content text-sm">
        <div className="text-sm sm:p-8 p-4  bg-base-100  rounded-2xl rounded-tr-none">
