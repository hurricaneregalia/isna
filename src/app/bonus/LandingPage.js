    ...
    <section className="py-12 px-4 sm:px-6 max-w-7xl mx-auto">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {landingPages.map((page) => (
          <div
            key={page.id}
            className="group bg-base-100 rounded-bl-3xl hover:shadow-lg transition-all duration-300 overflow-hidden flex flex-col  hover:-translate-y-1"
          >
