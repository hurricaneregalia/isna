  ...
  return (
    <section id={secId}>
      <div className="bg-cover bg-center" style={{ backgroundImage: `url(${data.image})` }}>
        <HeaderSectionMirka siteName={siteName} bgColor="  bg-primary/50" textColor="text-base-300" widthNavbar="max-w-7xl mx-auto sm:px-18 px-2" btnThemeBorder="border-base-100" />
        <div className=" bg-gradient-to-t from-primary  to-primary/50  w-full min-h-screen flex flex-col justify-start sm:justify-center sm:items-center items-start">
