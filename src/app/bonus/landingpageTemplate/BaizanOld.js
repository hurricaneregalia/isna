...
const data = {
  ...
  about: {
    ...
    description: "Kami percaya pakaian kasual bukan sekadar gaya, tapi cara hidup. Setiap potongan dirancang untuk menemani aktivitas sehari-hari dengan nyaman tanpa mengorbankan gaya.",
    usps: [
  ...
  faqs: [
    {
      ...
      answer: "Kami menyediakan panduan ukuran detail untuk setiap produk. Anda juga bisa berkonsultasi dengan tim kami via WhatsApp untuk rekomendasi ukuran.",
    },
    {
  ...
  return (
    <div className="font-sans text-gray-800">
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2">
              ...
              <button className="bg-gray-900 hover:bg-black text-white font-semibold px-6 py-3 rounded-full transition duration-300">Pelajari Lebih Lanjut</button>
            </div>
            <div className="lg:w-1/2 grid grid-cols-2 gap-4">
              {data.about.images.map((image, index) => (
                <div key={index} className="relative h-64 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition duration-300 transform hover:scale-105">
          ...
          {data.products.map((product, index) => (
            <div key={index} className="group bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition duration-300">
              <div className="relative h-64 overflow-hidden">
                <Image src={product.imageUrl} alt={product.name} layout="fill" objectFit="cover" className="group-hover:scale-105 transition duration-500" />
              ...
              <div className="p-4">
                ...
                <button className="mt-3 w-full bg-gray-100 hover:bg-amber-600 hover:text-white text-gray-800 py-2 rounded-full text-sm font-medium transition duration-300">Lihat Detail</button>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="relative py-32 px-4 text-center">
        <div className="absolute inset-0 bg-black/50 z-0">
          <Image src="https://images.unsplash.com/photo-1556905055-8f358a7a47b2?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80" alt="Happy customers" layout="fill" objectFit="cover" />
        </div>
