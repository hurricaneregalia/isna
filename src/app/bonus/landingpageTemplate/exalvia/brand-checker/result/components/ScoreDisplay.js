...
export default function ScoreDisplay({ result, myTest, getScoreBgColor, children }) {
  ...
  return (
    <>
      <div className="text-center border-4 border-white/50 rounded-3xl rounded-tr-none text-white">
        <div className="grid lg:grid-cols-2 grid-cols-1 lg:divide-x-4 divide-x-0 divide-white/50 ">
          <div className="scoring w-full">
            ...
            <div className="grid grid-cols-2 text-center sumary text-white lg:border-b-0 border-b-4  border-t-4 divide-x-4 divide-white/50 border-white/50 ">
              <div className="py-4">
