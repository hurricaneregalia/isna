...
export default function BtnLinkPrim({ btnTxt, btnUrl, iconLeft, shadow, iconRight, animate, btnFull, btnStyle, btnCustom }) {
  ...
  return (
    <Link
      href={btnUrl}
      className={`btn ${btnCustomFx} ${shadowFx}  hover:bg-amber-500 border-0  transition duration-300 hover:text-slate-900 ${btnFullFx} ${btnStyle}`}
    >
      {iconLeftFx}
      {btnTxt}
      {iconRightFx}
