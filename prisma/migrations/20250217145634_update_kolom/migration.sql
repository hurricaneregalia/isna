...
INSERT INTO "new_ServicesListItem" ("createDate", "desc", "icon", "id", "landingPageId", "title", "updateDate") SELECT "createDate", "desc", "icon", "id", "landingPageId", "title", "updateDate" FROM "ServicesListItem";
